...
class TipoFaltaController extends Controller
{
	 ...
	 * @return TipoFalta the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=TipoFalta::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param TipoFalta $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipo-falta-form')
		{
