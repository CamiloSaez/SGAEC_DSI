...
class ComunidadController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Comunidad']))//&&$_POST['Comuna']
		{
			...
			//$model->COMU_ID=Yii::app()->metodos->aOracion($model->COMU_ID); 
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('Comunidad',array(
            'criteria'=>array(
            'condition'=>"ADM_RUT='$usuarioActual'",
            ),
			));
			
		//CHtml::encode($data->ADM_RUT)==yii::app()->user->id)
